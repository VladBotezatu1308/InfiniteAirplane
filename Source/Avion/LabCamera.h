	...
	class MyCamera
	{
		public:
			...
			void MoveForward(float distance)
			{
				...
				// movement will keep the MyCamera at the same height always
				...
				// Translate the MyCamera using the DIR vector computed from forward
			}

			void TranslateForward(float distance)
			{
				// TODO : Translate the MyCamera using the "forward" vector
				position += distance * forward;
			}

			void TranslateUpword(float distance)
			{
				// TODO : Translate the MyCamera using the up vector
			...
			{
				// TODO
				// Translate the MyCamera using the "right" vector
				// Usually translation using MyCamera "right' is not very useful because if the MyCamera is rotated around the "forward" vector 
				// translation over the right direction will have an undesired effect; the MyCamera will get closer or farther from the ground
			...
			{
				// TODO
				// Rotate the MyCamera in Third Person mode - OX axis
			...
			{
				// TODO
				// Rotate the MyCamera in Third Person mode - OY axis
				TranslateForward(distanceToTarget);
			...
			{
				// TODO
				// Rotate the MyCamera in Third Person mode - OZ axis
				TranslateForward(distanceToTarget);
